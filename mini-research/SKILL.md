---
name: mini-research
description: Execute a scaled-down research workflow from question formulation, literature search, paper reading, synthesis to conclusion writing. Use when users mention "mini research project", "literature review", "research topic analysis", "academic research", "paper search and analysis", want to systematically study an academic question, need multi-tool comparison and validation, or need to generate research summaries.
---

# Mini Research - Research Workflow

Execute a scaled-down research process—from asking questions, finding literature, reading papers, synthesizing findings, to writing conclusions—to preliminarily identify research topics suitable for scientific study.
...
Each step's output should be saved to the workspace root directory with the following naming convention:

- `step1-question-refinement/` - Contains each tool's decomposition results and final research topic
- `step2-literature-search/` - Contains each tool's search results and filtered paper list
- `step3-literature-reading/` - Contains reading notes and summaries for each paper
- `step4-comprehensive-analysis/` - Contains analysis results and conflict identification
- `step5-research-summary/` - Contains final summary in three format files
